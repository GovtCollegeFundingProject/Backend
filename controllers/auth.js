...
const registerIndividual=async(req,res)=>{
    const {email,password,role,phoneNumber,whatsappCompatible,taxExemptionRequired,anonymous,
        aadhar,
        pan,
        salutation,
        name,
    ...
    res.status(201).send({ message: 'User registered successfully', user: newUser,individualUser });
